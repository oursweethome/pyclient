...
class SandboxApi(object):
    ...
    def sandbox_clear_post(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sandbox_clear_post_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def sandbox_currencies_balance_post(self, body, **kwargs):  # noqa: E501
        """Выставление баланса по валютным позициям  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sandbox_currencies_balance_post(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sandbox_currencies_balance_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.sandbox_currencies_balance_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def sandbox_currencies_balance_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Выставление баланса по валютным позициям  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sandbox_currencies_balance_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'broker_account_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `sandbox_currencies_balance_post`")  # noqa: E501
    ...
    def sandbox_positions_balance_post(self, body, **kwargs):  # noqa: E501
        """Выставление баланса по инструментным позициям  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sandbox_positions_balance_post(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SandboxSetPositionBalanceRequest body: Запрос на выставление баланса по инструментным позициям (required)
        :param str broker_account_id: Номер счета (по умолчанию - Тинькофф)
        :return: Empty
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sandbox_positions_balance_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.sandbox_positions_balance_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def sandbox_positions_balance_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Выставление баланса по инструментным позициям  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sandbox_positions_balance_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `sandbox_positions_balance_post`")  # noqa: E501
    ...
    def sandbox_register_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param SandboxRegisterRequest body: Запрос на создание счета и выставление баланса по валютным позициям
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sandbox_register_post_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def sandbox_remove_post(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.sandbox_remove_post_with_http_info(**kwargs)  # noqa: E501
            return data
