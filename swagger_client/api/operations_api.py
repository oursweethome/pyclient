...
class OperationsApi(object):
    ...
    def operations_get(self, _from, to, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.operations_get_with_http_info(_from, to, **kwargs)  # noqa: E501
            return data
    ...
    def operations_get_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        ...
        all_params = ['_from', 'to', 'figi', 'broker_account_id']  # noqa: E501
        ...
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `operations_get`")  # noqa: E501
