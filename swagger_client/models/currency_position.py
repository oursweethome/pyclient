...
class CurrencyPosition(object):
    ...
    def __init__(self, currency=None, balance=None, blocked=None):  # noqa: E501
        """CurrencyPosition - a model defined in Swagger"""  # noqa: E501
        self._currency = None
        self._balance = None
        self._blocked = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CurrencyPosition, dict):
