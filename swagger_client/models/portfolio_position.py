...
class PortfolioPosition(object):
    ...
    def __init__(self, figi=None, ticker=None, isin=None, instrument_type=None, balance=None, blocked=None, expected_yield=None, lots=None, average_position_price=None, average_position_price_no_nkd=None, name=None):  # noqa: E501
        """PortfolioPosition - a model defined in Swagger"""  # noqa: E501
        self._figi = None
        self._ticker = None
        self._isin = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortfolioPosition, dict):
